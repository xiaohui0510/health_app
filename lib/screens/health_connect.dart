...
import '../utils/health_data_type.dart';
...
class HealthAppState extends State<HealthApp> {
  ...
  Future<void> authorize() async {
    // Request Activity Recognition permission (needed for steps and workouts)
    if (await Permission.activityRecognition.isDenied) {
      await Permission.activityRecognition.request();
    }

    // Request Location permission (needed for workouts with distance tracking)
